 ...
 */
    ...
    */
    AEGIS_DECL LSW::v5::Tools::Future<gateway::objects::invite> get_guild_invite(std::string invite_code);

    /// Get active guild invites
    /**
    * @returns aegis::future<gateway::objects::invites>
    */
    AEGIS_DECL LSW::v5::Tools::Future<gateway::objects::invites> get_guild_invites();
    ...
    */
    AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> delete_guild_invite(std::string invite_code);
