...
public:
     ...
     */
    AEGIS_DECL LSW::v5::Tools::Future<gateway::objects::message> create_message(const std::string & content, int64_t nonce = 0);
     ...
     * @returns LSW::v5::Tools::Future<gateway::objects::message>
     */
    AEGIS_DECL LSW::v5::Tools::Future<gateway::objects::message> create_message(create_message_t obj);
     ...
     * @returns LSW::v5::Tools::Future<gateway::objects::message>
     */
    AEGIS_DECL LSW::v5::Tools::Future<gateway::objects::message> create_message_embed(const std::string & content, const json & embed, int64_t nonce = 0);
     ...
     * @returns LSW::v5::Tools::Future<gateway::objects::message>
     */
    AEGIS_DECL LSW::v5::Tools::Future<gateway::objects::message> create_message_embed(create_message_t obj);
     ...
     * @returns LSW::v5::Tools::Future<gateway::objects::message>
     */
    AEGIS_DECL LSW::v5::Tools::Future<gateway::objects::message> get_message(snowflake message_id);

    /// Get multiple messages from this channel
    /**
     * @see aegis::get_messages_t
     * @param obj Struct of the request
     * @returns LSW::v5::Tools::Future<gateway::objects::messages>
     */
    AEGIS_DECL LSW::v5::Tools::Future<gateway::objects::messages> get_messages(get_messages_t obj);
     ...
     * @returns LSW::v5::Tools::Future<gateway::objects::message>
     */
    AEGIS_DECL LSW::v5::Tools::Future<gateway::objects::message> edit_message(snowflake message_id, const std::string & content);
     ...
     * @returns LSW::v5::Tools::Future<gateway::objects::message>
     */
    AEGIS_DECL LSW::v5::Tools::Future<gateway::objects::message> edit_message(edit_message_t obj);
     ...
     * @returns LSW::v5::Tools::Future<gateway::objects::message>
     */
    AEGIS_DECL LSW::v5::Tools::Future<gateway::objects::message> edit_message_embed(snowflake message_id, const std::string & content, const json & embed);
     ...
     * @returns LSW::v5::Tools::Future<gateway::objects::message>
     */
    AEGIS_DECL LSW::v5::Tools::Future<gateway::objects::message> edit_message_embed(edit_message_t obj);
     ...
     */
    AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> delete_message(snowflake message_id);
     ...
     * @returns LSW::v5::Tools::Future<rest::rest_reply>
     */
    AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> bulk_delete_message(const std::vector<snowflake> & messages);
     ...
     * @returns LSW::v5::Tools::Future<rest::rest_reply>
     */
    AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> get_reactions(snowflake message_id, const std::string & emoji_text);
     ...
     * @returns LSW::v5::Tools::Future<rest::rest_reply>
     */
    AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> delete_all_reactions(snowflake message_id);
     ...
     * @returns LSW::v5::Tools::Future<rest::rest_reply>
     */
    AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> edit_channel_permissions(snowflake _overwrite_id, int64_t _allow, int64_t _deny, const std::string & _type);
    ...
    */
     ...
     * @returns LSW::v5::Tools::Future<rest::rest_reply>
     */
    AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> delete_channel_permission(snowflake overwrite_id);
     ...
     * @returns LSW::v5::Tools::Future<rest::rest_reply>
     */
    AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> add_pinned_channel_message(snowflake message_id);

    /// Delete a pinned message in channel
    /**
     * @returns LSW::v5::Tools::Future<rest::rest_reply>
     */
    AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> delete_pinned_channel_message(snowflake message_id);

    /// Add member to a group direct message
    /**
     * @returns LSW::v5::Tools::Future<rest::rest_reply>
     */
    AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> group_dm_add_recipient(snowflake user_id);

    /// Remove member from a group direct message
    /**
     * @returns LSW::v5::Tools::Future<rest::rest_reply>
     */
    AEGIS_DECL LSW::v5::Tools::Future<rest::rest_reply> group_dm_remove_recipient(snowflake user_id);
